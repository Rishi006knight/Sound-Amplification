...
struct ThresholdPoint {
    ...
    float thresholdDbHL{0.0f};  // Hearing loss in dB HL (0 - 120)
    float mclDbHL{65.0f};       // Most Comfortable Level
    float uclDbHL{100.0f};      // Uncomfortable Loudness Level
};
...
public:
    ...
    // Pure-Tone Average (PTA3 = average of 500, 1000, 2000 Hz)
